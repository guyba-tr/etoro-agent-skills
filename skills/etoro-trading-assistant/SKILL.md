...
- **A new trade where available cash is insufficient** → also a rebalance trigger. Load `references/rebalancing.md` ("Insufficient-cash variant") for the prioritization rules on which existing position(s) to reduce.
